...
class ChernarusPlusSpawner
{
	class AISpawnerParams
	{
		territoriesFiles[]=
		{
			"DZ\worlds\chernarusplus\ai\cattle_territories.xml",
			"DZ\worlds\chernarusplus\ai\sheep_goat_territories.xml",
			"DZ\worlds\chernarusplus\ai\red_deer_territories.xml",
			"DZ\worlds\chernarusplus\ai\roe_deer_territories.xml",
			"DZ\worlds\chernarusplus\ai\wild_boar_territories.xml",
			"DZ\worlds\chernarusplus\ai\pig_territories.xml",
			"dz\worlds\chernarusplus\ai\hen_territories.xml",
			"dz\worlds\chernarusplus\ai\wolf_territories.xml",
			"DZ\worlds\chernarusplus\ai\hare_territories.xml",
			"DZ\worlds\chernarusplus\ai\zombie_territories.xml"
		};
		class HerdDeer
		{
			usableTerritories[]=
