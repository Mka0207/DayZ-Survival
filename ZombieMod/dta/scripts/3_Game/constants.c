...
const float	STAMINA_DRAIN_MELEE_HEAVY = 60; //in units (how much heavy melee punch depletes stamina)
const int	STAMINA_DRAIN_MELEE_EVADE = 24; // in units (how much evade depletes stamina)
	
const int 	STAMINA_GAIN_JOG_PER_SEC = 6; //in units (how much of stamina units is gained while jogging)
const int 	STAMINA_GAIN_WALK_PER_SEC = 12; //in units (how much of stamina unitsis gained while walking)
const int 	STAMINA_GAIN_IDLE_PER_SEC = 3; //in units (how much of stamina unitsis gained while iddling)
const float STAMINA_GAIN_BONUS_CAP = 12.0; //in units (tells how much extra units can be added at best to stamina regain)
