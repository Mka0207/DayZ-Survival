...
const int 	STAMINA_DRAIN_STANDING_SPRINT_PER_SEC = 1.6; //in units (how much sprint depletes stamina)
const int 	STAMINA_DRAIN_CROUCHED_SPRINT_PER_SEC = 0.3; //in units (how much sprint in crouch depletes stamina)
